...
const ReviewForm  = (props) => {
  const ratingOptions = [1,2,3,4,5].map((score, index) => {
    return(
      <Fragment>
      <input type="radio" value={score} checked = {props.review.score==score} name='rating' onChange={() => console.log('seclted ', score)} key= {score}/>
  ...
  return (
    <ReviewWrapper>
      <form onSubmit={props.handleSubmit}>
        <ReviewHeadline>Have an experience with {props.attributes.name} Share ypur review!</ReviewHeadline>
        <Field>
        ...
        <Field>
         <RatingContainer>
           <RatingBoxTitle> Rate the airline</RatingBoxTitle>
            <RatingBox>
            {ratingOptions}
            </RatingBox>
